...
export { default as videoGirl } from './video-girl.mp4'
export { default as truckMainVideo } from './truck-main-video.mp4'
export { default as movingTruck } from './moving-truckjj.mp4'
