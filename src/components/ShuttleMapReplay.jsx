        ...
        <div className="relative w-full">
          ...
          <div className="relative bg-gray-100 rounded-2xl p-4 shadow-2xl border-4 border-gray-300">
            ...
            <div className="relative bg-gray-50 rounded-xl overflow-hidden">
              ...
              <div className="absolute top-4 right-4 bg-lightblue/90 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                <div className="flex items-center space-x-2">
              ...
              <div className="absolute bottom-4 right-4 bg-darkblue/90 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                <div className="text-right">
                  <div className="text-white text-sm font-semibold">ETA</div>
                  <div className="text-white text-lg font-bold">03 min</div>
                </div>
              </div>
            </div>
          </div>
